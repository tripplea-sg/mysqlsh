...
def installPlugin():
    ...
    A function to:
        ...
        Install VALIDATE_PASSWORD plugin on the stand-alone database and InnoDB Cluster / Group Replication
...
def setPolicy():
    ...
    A function to:
        ...
        set PERSIST VALIDATE_PASSWORD_* variables on the stand-alone database and InnoDB Cluster / Group Replication
